...
class Clubs: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let csvURL2 = NSURL(fileURLWithPath: Bundle.main.path(forResource: "clubs", ofType: ".txt")!)
    ...
    func initializeTheRecipes() {
        ...
        while (p < lines2.count) {
            ...
            recipes.append(Recipe2(name2: name_2, thumbnails2: "clubsprof.png", prepTime2: " "))
            p += 1
        }
